 ...
 -->
  <div class="page my-4 title1">
        <div class="mt-5">
            ...
            <div class="detail">
                <div class="form">      
                  <form method="post" action="{{url('/vender/store_update_product_image')}}/{{$id}}" enctype="multipart/form-data">  
                  	...
                  	@csrf
                            ...
                            <div class="part">
                              ...
                              <div class="col-md-12">
                                 <input type="file" name="m_product_image" onchange="readURL1(this);" value="">
                                 <img id="blah1" src="/uploads/{{$m_product_image}}" width="100px" height="100px" alt="">
                                 @if($errors->has('m_product_image')) <p class="error_mes">{{ $errors->first('m_product_image') }}</p> @endif
                                 <input type="hiddden" name="oldimage" value="{{$m_product_image}}">
                               </div>   
                            </div>
