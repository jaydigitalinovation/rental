         ...
         <ul class="menu main_drop">
            <li><a href="#"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  ...
                  <li><a href="dashboard.html">Get Started Inquiry</a></li>
               </ul>
            </li>
            <li><a href="homebanner.html"><i class="fas fa-home"></i> <span>Home page banner</span></a>
            </li>
            <li><a href="#"><i class="fas fa-file-alt"></i> <span>Product</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  <li><a href="{{url('/vender/a_product')}}">All Product</a></li>
                  <li><a href="{{url('/vender/category')}}">All Categories</a></li>
                  <li><a href="{{url('/vender/product_type')}}">Type of product</a></li>
               </ul>
            </li>
            <li><a href="#"><i class="fas fa-phone-alt"></i> <span>Contact</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  <li><a href="#">Contact Us page banner</a></li>
                  <li><a href="#">Contact Us page Description</a></li>
                  <li><a href="#">Get In Touch</a></li>
               </ul>
            </li>
            <li><a href="#"><i class="fas fa-table"></i> <span>Header-Footer</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  <li><a href="footerproduct.html">Footer Product</a></li>
                    ...
                    <div class="dropdown1">
                      <button id="myBtn1">
                        ...
                        <div id="myDropdown1" class="dropdown-content1">
                          ...
                          <a href="#"><i class="fas fa-lock"></i>Logout</a>
                        </div>
                    </div>
                  </div>
                     ...
                     <div class="login">
                       <div class="dropdown1">
                         <button id="myBtn1">
                           ...
                           <div id="myDropdown1" class="dropdown-content1">
                              <a href="{{url('/vender/edit_profile')}}">Edit Profile</a>
                             <a href="{{url('/vender/logout')}}"><i class="fas fa-lock"></i>Logout</a>
                           </div>
                       </div>
                     </div>
                 </div>
