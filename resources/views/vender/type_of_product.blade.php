  ...
  <div id="saveform_errList"></div>
          <div class="mt-5">
              <div class="list1">
                  ...
                  <button class="btn1"><a href="{{url('/vender/add_product_type')}}" style="color:white;">ADD</a></button>
              </div>
                      ...
                      <tbody>
                          <tr class="data_{{$u->id}}">
                            ...
                            <td>{{$u->name}}</td>
                              ...
                              <td>
                                <button class="glow-on-hover"><a href="{{url('/vender/update_product_type')}}/{{$u->id}}"><i class="fal fa-pencil"></i></a></button>
                              </td>
                              <td>
                                <button class="glow-on-hover"><a href="{{url('/vender/delete_product_type')}}/{{$u->id}}"><i class="fal fa-trash-alt"></i></a></button>
