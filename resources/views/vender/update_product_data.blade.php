 ...
 -->
  <div class="page my-4 title1">
        <div class="mt-5">
            ...
            <div class="detail">
                <div class="form">      
                  <form method="post" action="{{url('/vender/store_update_product_data')}}/{{$id}}" enctype="multipart/form-data">  
                  	...
                  	@csrf
                            ...
                            <div class="part">
                              ...
                              <div class="col-md-12">
                                 <input type="file" name="product_image" onchange="readURL1(this);" value="">
                                 <img id="blah1" src="/uploads/{{$product_image}}" width="100px" height="100px" alt="">
                                 @if($errors->has('product_image')) <p class="error_mes">{{ $errors->first('product_image') }}</p> @endif
                                 <input type="hiddden" name="oldimage" value="{{$product_image}}">
                               </div>   
                            </div>
