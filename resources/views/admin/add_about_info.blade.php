            ...
            <div class="detail">
              ...
              <div id="success_message"></div>
                <div class="form"> 
                  ...
                  <form method="post" enctype="multipart/form-data" id="addData" action="{{url('/admin/store_add_about_info')}}">  
                  	...
                  	@csrf
                          <div class="part">
                              ...
                              <div class="col-md-12 data">
                                  <input type="text" placeholder="name" name="name" value="" class="name">
                          ...
                          <div class="part">
                              ...
                              <div class="col-md-12 data">
                                  <input type="text" placeholder="email" name="email" value="" class="email">
