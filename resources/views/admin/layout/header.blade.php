...
<body>  
   <header class="page-header">
      <nav class="main-menu">
         <a href="index.html"class="logo"><img src="/image/logo.png" alt="img"></a>
         <ul class="menu main_drop">
            ...
            <li><a href="#"><i class="fas fa-chart-pie"></i> <span>Category</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  <li><a href="{{url('/admin/category')}}">Add Your Category</a></li>
                  <li><a href="{{url('/admin/sub_category')}}">Add Your Sub_category</a></li>
                  <li><a href="{{url('/admin/about')}}">About</a></li>
               </ul>
            </li>
            <li><a href="#"><i class="fas fa-chart-pie"></i> <span>Shop</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
