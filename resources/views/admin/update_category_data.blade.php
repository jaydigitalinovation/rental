 ...
 -->
  <div class="page my-4 title1">
        <div class="mt-5">
            ...
            <div class="detail">
                <div class="form">      
                  <form method="post" action="{{url('/admin/store_update_category_data')}}/{{$id}}" enctype="multipart/form-data">  
                  	...
                  	@csrf
                            ...
                            <div class="part">
                              ...
                              <div class="col-md-12">
                                 <input type="file" name="icon" onchange="readURL1(this);" value="">
                                 <img id="blah1" src="/uploads/{{$icon}}" width="100px" height="100px" alt="">
